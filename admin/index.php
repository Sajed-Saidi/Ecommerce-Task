...
$brandsCount = mysqli_num_rows($brands);
                ...
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-sm ">Recently Added 1</p>
                ...
                <div class="col-lg-4 col-md-6 mt-4 mb-4">
                    <div class="card z-index-2  ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-sm "> (<span class="font-weight-bolder">+15%</span>) increase in today . </p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
                                <p class="mb-0 text-sm"> Last updated 2 hours ago. </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 mt-4 mb-3">
                    <div class="card z-index-2 ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-sm ">23 items have been brought recently.</p>
                            <hr class="dark horizontal">
                            <div class="d-flex ">
                                <i class="material-icons text-sm my-auto me-1">schedule</i>
